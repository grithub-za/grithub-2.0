...
import sevengage from '@/public/assets/partners/sevengage-logo.svg'
  ...
  return (
    <>
      <main className="container-fluid d-flex p-0 flex-column">
          ...
          <div className={Style.hero}>
            ...
            >
              ...
              <p className={Style.heroSubText}>
                We drive innovation and entrepreneurship to create an inclusive and competitive
                digital workforce.
              </p>
              <p>
                <Link
                  href="/about"
                  className="btn rounded-pill rounded-pill btn-danger btn-lg px-4"
                  title="learn more about grit hub"
                >
                  Learn more
                </Link>
              </p>
            ...
            <div className={clsx(Style.heroPartners, ['ps-md-5', 'ps-3, d-none d-md-block'])}>
              ...
              <div className="col-12 d-flex justify-content-start align-items-center flex-wrap">
                ...
                <div className="col-2 pe-5 d-none d-md-block">
                  <a
                    title="coder dojo"
                    href="https://zen.coderdojo.com/dojos/za/george-municipality/george-western-cape-garden-route-innovation-and-technology-hub"
                    target="_blank"
                    className="d-block"
                    rel="noreferrer"
                  >
                ...
                <div className="col-2 pe-5 d-none d-md-block">
                  <a
                    title="sevengage proud supporter"
                    href="https://sevengage.com"
                    target="_blank"
                    className="d-block"
                    rel="noreferrer"
                  >
                ...
                <div className="col-2 pe-5 d-none d-md-block">
                  <a
                    title="george business chamber member"
                    href="https://georgechamber.co.za/"
                    target="_blank"
                    className="d-block"
                    rel="noreferrer"
                  >
                ...
                <div className="col-2 d-none d-md-block">
                  <a
                    title="mossel bay business chamber member"
                    href="https://mosselbaychamber.co.za/"
                    target="_blank"
                    className="d-block"
                    rel="noreferrer"
                  >
        ...
        <section
          className="container-xxl col-12 d-flex justify-content-center align-items-center p-4 p-md-5 flex-column"
          id="about"
        >
          <h1 className="fw-bold display-4 mb-1 text-center">
            Garden Route Innovation &amp; Technology Hub
          </h1>

          <div className="text-center col-xl-12 col-12">
            <p className="lead text-muted fs-3">
              We provide workforce training, apprenticeships, tools, and mentorship opportunities to
              individuals, small businesses and startups in the Garden Route area...and all it takes
        ...
        <section className="container-xxl col-12 d-flex justify-content-center align-items-center p-0 mb-5 flex-column">
          <div className="col-12 d-flex flex-wrap">
              ...
              <div className="card shadow-sm h-100">
                <Link href="/cowork" title="coworking spaces">
                  <Image
                    ...
                    alt="About our coworking spaces"
                  />
                </Link>
                <div className="card-body d-flex flex-column">
                  <h2 className="card-title fs-4 fw-bold">Coworking</h2>
                  <p className="card-text">
                    Modern, sleek and creative spaces fostering collaboration and productivity so
                    that you can work without distraction.{' '}
                    <Link
                      href="/cowork"
                      className="text-decoration-underline"
                      title="more about coworking"
                    >
                      More &rsaquo;
                    </Link>
                  </p>
            ...
            <div className="col-xl-4 col-md-6 col-12 p-2">
              <div className="card shadow-sm h-100">
                <Link href="/programs" title="programs">
                  <Image
                    src="/assets/ai-grithub-course-2025.jpg"
                    width={500}
                    height={333}
                    className={Style.cardTopImg}
                    alt="Workshops and Programs"
                  />
                </Link>
                <div className="card-body d-flex flex-column">
                  <h2 className="card-title fs-4 fw-bold">Real Workforce Training</h2>
                  <p className="card-text">
                    Programing and Industry workshops using the latest real-world knowledge from
                    industry experts.{' '}
                    <Link
                      href="/programs"
                      className="text-decoration-underline"
            ...
            <div className="col-xl-4 col-md-6 col-12 p-2">
              <div className="card shadow-sm h-100">
                <Link href="/incubation" title="smme incubator">
                  <Image
                    src="/assets/incubator-thumb.jpg"
                    width={500}
                    height={333}
                    className={Style.cardTopImg}
                    alt="Entrepreneurship Incubation"
                  />
                </Link>
                <div className="card-body d-flex flex-column">
                  <h2 className="card-title fs-4 fw-bold">Entrepreneurship Incubation</h2>
                  <p className="card-text">
                    Tailored workshops, networking, online learning and hands-on mentorship for
                    accelerating business growth.{' '}
                    <Link
                      href="/incubation"
                      className="text-decoration-underline"
                      title="more about incubation"
                    >
                      More &rsaquo;
                    </Link>
                  </p>
            ...
            <div className="d-md-flex d-xs-none d-xl-none col-xl-4 col-md-6 col-12 p-md-5 p-4 justify-content-center flex-column align-item-center">
              ...
              <p className="lead">
                Our core values of: Collaboration, Equality, Responsibility, Entrepreneurial Ethic,
                Innovation and a Giving Spirit not only bind us, but guide us.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="container-xxl col-12 d-flex justify-content-center align-items-center p-0 mb-5 flex-column">
          <h2 className="fw-bold display-5 mt-5 pt-5 mb-0 text-center">STEM Education Programs</h2>

          <div className="col-12 d-flex flex-wrap">
            <div className="col-xl-4 col-md-6 col-12 p-3">
              <div className="card shadow-sm position-relative h-100 align-items-center">
                <div className={`${ribbon.ribbon_top_right} ${ribbon.ribbon__green}`}>
                  <span>STEM</span>
                </div>
                <Image
                  src="/assets/CoderDojo-Logo.svg"
                  width={250}
                  height={150}
                  className={Style.cardTopOverflow}
                  alt="STEM"
                />
                <div className="card-body d-flex flex-column justify-content-between">
                  ...
                  <p className="card-text">
                    ...
                    Anyone aged 7 to 17 can visit a Dojo and learn to code, build a website, or
                    create an app or game. Dojos are a space for kids and teens to explore
                    technology in an informal, creative, safe and social environment.
                  </p>
                  <p className="d-grid">
                    <a
                      href="/programs/dojo"
                      className="btn rounded-pill btn-danger btn-lg"
                      title="more about our coder dojos"
                    >
                      Learn more
                    </a>
                  </p>
            ...
            <div className="col-xl-4 col-md-6 col-12 p-3">
              <div className="card shadow-sm position-relative h-100 align-items-center">
                ...
                <div className="card-body d-flex flex-column justify-content-between">
                  ...
                  <p className="card-text">
                    We are a partner in science, technology and industrial learning to supplement
                    the inadequate number of teachers skilled to educate in these areas. We will
                    promote STEM careers, and teach short courses as well as create fun STEM based
                    science events.
                  </p>
                  <p className="d-grid">
            ...
            <div className="col-xl-4 col-md-6 col-12 p-3">
              <div className="card shadow-sm position-relative h-100 align-items-center">
                ...
                <div className="card-body d-flex flex-column justify-content-between">
                  ...
                  <p className="card-text">
                    Designed for young innovators aged 4 to 16, FIRST LEGO League offers a
                    progressive pathway that grows with each learner, from playful exploration to
                    real-world problem-solving through coding, engineering, and research. Learners
                    worldwide tackle themed challenges and connect through dynamic local and global
                    events that celebrate creativity, collaboration, and innovation.
                  </p>
                  <a
                    className="btn rounded-pill btn-danger btn-lg"
                    href="/newsroom/unearthing-curiosity-grit-hub-at-the-first-lego-league-challenge"
                    target="_blank"
                    rel="noreferrer"
                    title="learn more about first lego league"
                  >
                    Learn more
                  </a>
                </div>
        ...
        <section className="container-xxl col-12 d-flex justify-content-center align-items-center p-0 mb-5 flex-column">
          ...
          <p className="lead text-muted fs-3 text-center mb-5">
            Identifying untapped inclusive human potential and refocusing it using the power of
            digital technology. &nbsp;
            <a href="/programs" title="learn more about our programs">
              View All Workforce Trainings and Programs &rsaquo;
            </a>
          </p>
        ...
        <section className="container-xxl col-12 d-flex justify-content-center align-items-center p-0 mb-5 flex-column">
          <h2 className="fw-bold display-5 mt-5 mb-0 text-center">Our Newsroom</h2>

          <p className="lead text-muted fs-3 text-center mb-5">
            Stories, Insights, and Opportunities from GRIT Hub's Tech Ecosystem.
            <br />
            <a href="/newsroom" title="read all">
              View all newsroom articles &rsaquo;
            </a>
          </p>

          <div className="col-12 d-flex flex-wrap">
            {latest.map((post) => {
              return <NewsroomPod key={post.slug?.current} {...post} />
            })}
          </div>
        </section>
      </main>
